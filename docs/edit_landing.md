...
首先，感谢您愿意为 **本文档** 做出自己的贡献。

不过在开始之前，我们需要您了解并熟知须知里的内容，以避免在编辑时产生不必要的麻烦。
...
<script>
	...
	document.getElementById("btn-startedit").href = "https://github.com/XMOJ-Script-dev/XMOJ-Script-dev/edit/master/docs" + getQueryVariable("ref", "");
</script>
